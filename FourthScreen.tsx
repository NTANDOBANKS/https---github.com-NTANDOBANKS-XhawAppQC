  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'brown' }}>
      ...
      <View style={{ flex: 1, alignItems: 'center', padding: 20, backgroundColor: 'white' }}>
        <Text style={{ fontSize: 24, fontWeight: 'bold', marginBottom: 10 }}>Landscaping</Text>
        ...
        This learnership teaches how to provide landscaping services for new
        and established gardens
        </Text>
        <Text style={{ fontSize: 24, fontWeight: 'bold', marginBottom: 10 }}>What you will learn:</Text>

        <View>
  <Text style={{ marginBottom: 5 }}>- Indigenous and exotic plants and trees</Text>
  <Text style={{ marginBottom: 5 }}>- Fixed Structures (fountains, statues, benches, tables, built-in braai)</Text>
  <Text style={{ marginBottom: 5 }}>- Aesthetics of plant shapes and colours</Text>
  <Text style={{ marginBottom: 5 }}>- Alterations</Text>
  <Text style={{ marginBottom: 5 }}>- Garden Layout</Text>
</View>
