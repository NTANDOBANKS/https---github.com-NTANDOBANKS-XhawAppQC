  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'brown' }}>
      ...
      <View style={{ flex: 1, alignItems: 'center', padding: 20, backgroundColor: 'white' }}>
        <Text style={{ fontSize: 24, fontWeight: 'bold', marginBottom: 10 }}>Sewing </Text>
        ...
        This learnership teaches how to do alterations and new garment tailoring services
        </Text>
        <Text style={{ fontSize: 24, fontWeight: 'bold', marginBottom: 10 }}>What you will learn:</Text>

        <View>
  <Text style={{ marginBottom: 5 }}>- Types of stitches</Text>
  <Text style={{ marginBottom: 5 }}>- Threading a sewing machine</Text>
  <Text style={{ marginBottom: 5 }}>- Sewing buttons, zips, hems and seams</Text>
  <Text style={{ marginBottom: 5 }}>- Alterations</Text>
  <Text style={{ marginBottom: 5 }}>- Designing and sewing new garments</Text>
</View>
